/// \file optical/SciCRT/src/SciCRTPhysicsListMessenger.cc
/// \brief Implementation of the SciCRTPhysicsListMessenger class
//
//
#include "globals.hh"
...
SciCRTPhysicsListMessenger::SciCRTPhysicsListMessenger(SciCRTPhysicsList* pPhys)
  : fPhysicsList(pPhys)
{

    fDirectory = new G4UIdirectory("/SciCRT/phys/");
    fDirectory->SetGuidance("SciCRTPhysicsList control");
 
    fSetAbsorptionCMD = new G4UIcmdWithABool("/SciCRT/setAbsorption", this);
    fSetAbsorptionCMD->SetGuidance("Turn on or off absorption process");
    fSetAbsorptionCMD->AvailableForStates(G4State_Idle);

    fVerboseCmd = new G4UIcmdWithAnInteger("/SciCRT/phys/verbose",this);
    ...
    fCerenkovCmd =
                new G4UIcmdWithAnInteger("/SciCRT/phys/cerenkovMaxPhotons",this);
    ...
    fGammaCutCMD = new G4UIcmdWithADoubleAndUnit("/SciCRT/phys/gammaCut",this);
    ...
    fElectCutCMD = new G4UIcmdWithADoubleAndUnit("/SciCRT/phys/electronCut",this);
    ...
    fPosCutCMD = new G4UIcmdWithADoubleAndUnit("/SciCRT/phys/positronCut",this);
    ...
    fAllCutCMD = new G4UIcmdWithADoubleAndUnit("/SciCRT/phys/allCuts",this);
    ...
    fStepMaxCMD = new G4UIcmdWithADoubleAndUnit("/SciCRT/phys/stepMax",this);
    ...
    fClearPhysicsCMD =
                  new G4UIcmdWithoutParameter("/SciCRT/phys/clearPhysics",this);
    fClearPhysicsCMD->SetGuidance("Clear the physics list");
    fClearPhysicsCMD->AvailableForStates(G4State_PreInit,G4State_Idle);

    fRemovePhysicsCMD = new G4UIcmdWithAString("/SciCRT/phys/removePhysics",this);
    fRemovePhysicsCMD->
    ...
    fListCMD = new G4UIcmdWithoutParameter("/SciCRT/phys/list",this);
...
SciCRTPhysicsListMessenger::~SciCRTPhysicsListMessenger()
{
    delete fVerboseCmd;
    delete fCerenkovCmd;
...
void SciCRTPhysicsListMessenger::SetNewValue(G4UIcommand* command,
                                          G4String newValue)
{
