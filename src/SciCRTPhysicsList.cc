/// \file optical/SciCRT/src/SciCRTPhysicsList.cc
/// \brief Implementation of the SciCRTPhysicsList class
//
//
#include "SciCRTPhysicsList.hh"
#include "SciCRTPhysicsListMessenger.hh"
...
SciCRTPhysicsList::SciCRTPhysicsList(G4String physName) : G4VModularPhysicsList()
{
...
//       if(!phys)G4Exception("SciCRTPhysicsList::SciCRTPhysicsList","InvalidSetup",
//                            FatalException,"PhysicsList does not exist");
       fMessenger = new SciCRTPhysicsListMessenger(this);
//    }
    ...
    fPhysicsVector->push_back(new SciCRTExtraPhysics());
    fPhysicsVector->push_back(fOpticalPhysics =
                                        new SciCRTOpticalPhysics(fAbsorptionOn));

    fPhysicsVector->push_back(new G4RadioactiveDecayPhysics());

    fStepMaxProcess = new SciCRTStepMax();
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

SciCRTPhysicsList::~SciCRTPhysicsList()
{
    delete fMessenger;
...
void SciCRTPhysicsList::ClearPhysics()
{
...
void SciCRTPhysicsList::ConstructParticle()
{
...
void SciCRTPhysicsList::ConstructProcess()
{
...
void SciCRTPhysicsList::RemoveFromPhysicsList(const G4String& name)
{
    ...
    if (!success) {
       ...
       G4Exception("example SciCRTPhysicsList::RemoveFromPhysicsList()",
       "ExamSciCRTPhysicsList01",FatalException,message);
    }
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void SciCRTPhysicsList::SetAbsorption(G4bool toggle)
{
       fAbsorptionOn = toggle;
       RemoveFromPhysicsList("Optical");
       fPhysicsVector->
                    push_back(fOpticalPhysics = new SciCRTOpticalPhysics(toggle));
       fOpticalPhysics->ConstructProcess();
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void SciCRTPhysicsList::SetCuts()
{
    if (verboseLevel >0) {
        G4cout << "SciCRTPhysicsList::SetCuts:";
...
void SciCRTPhysicsList::SetCutForGamma(G4double cut)
{
    fCutForGamma = cut;
...
void SciCRTPhysicsList::SetCutForElectron(G4double cut)
{
    fCutForElectron = cut;
...
void SciCRTPhysicsList::SetCutForPositron(G4double cut)
{
    fCutForPositron = cut;
...
void SciCRTPhysicsList::SetStepMax(G4double step)
{
...
SciCRTStepMax* SciCRTPhysicsList::GetStepMaxProcess()
{
...
void SciCRTPhysicsList::AddStepMax()
{
...
void SciCRTPhysicsList::SetNbOfPhotonsCerenkov(G4int maxNumber)
{
...
void SciCRTPhysicsList::SetVerbose(G4int verbose)
{
